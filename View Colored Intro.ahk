...
;
; Game settings `Message Speed` must be set to `Fast`.
; When the health of Riou & Jowy are critical, pause the script to use Medicine.
; The counter will not be reset when the script is continued.
;
; Game     : S2
